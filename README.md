...
**🍇 Updates**
- **`2025/3/17`** Added support for [Hugging Face Inference Endpoints](#hugging-face-inference-endpoint). You can now deploy FastSAM as a custom inference endpoint.
